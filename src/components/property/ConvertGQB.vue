<template>
  <div class="ConvertGQB">
    <!-- 头部 -->
    <van-nav-bar left-arrow title="转换" @click-left="routerBack" />
    <div class="content">
      <van-cell-group>
        <div class="input_title">转换币种：</div>
        <van-field v-model="mobileNumber" disabled />
        <div class="input_title">转换数量：</div>
        <van-field v-model="TransNumber" placeholder="请输入兑换数量" />
        <div class="usable">可用{{gameCoinMoney}}股权币</div>
